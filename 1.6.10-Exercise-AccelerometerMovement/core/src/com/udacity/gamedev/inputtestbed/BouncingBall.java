...
public class BouncingBall extends InputAdapter {
    ...
    public void update(float delta) {
        ...
        float accelX = - ACCELERATION * xAxis / (ACCELEROMETER_SENSITIVITY * ACCELERATION_OF_GRAVITY);
        float accelY = - ACCELERATION * yAxis / (ACCELEROMETER_SENSITIVITY * ACCELERATION_OF_GRAVITY);
